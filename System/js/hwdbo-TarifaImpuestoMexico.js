...
function GetGrid() 
{
    $.when(ajaxCatalogo(65,"")).done(function (response) {
                ...
                case 6:
                    ...
                    case 7:
                        _columns.push({
                            ...
                            validation: function (cell, value) {
                                if (value < 0 ) {
                                    return { result: false, message: "Por favor ingrese una cantidad mayor o igual cero. Para salir presione ESC" };
                                }
                                if(value > 1)
                                {
...
function DescargaExcel() {
	...
	setTimeout(() => {
		...
		if (rows.length > 0) {
			WriteExcel(rows, 'TarifaImpuestoMexico');
		}
		ocultarCargador();
	}, 1000);
}
...
function Guardar()
{
    ...
    {
        var obj = new Object();
        obj.API="19B6B5073269566605013A9816AE2CEE4F562769EA7221A275D7832E7CF3A8D9";
        obj.Parameters="";

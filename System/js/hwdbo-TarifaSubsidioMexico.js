...
function GetGrid() 
{
    $.when(ajaxCatalogo(66,"")).done(function (response) {
...
function DescargaExcel() {
	...
	setTimeout(() => {
		...
		if (rows.length > 0) {
			WriteExcel(rows, 'TarifaSubsidioMexico');
		}
		ocultarCargador();
	}, 1000);
}
...
function Guardar()
{
    ...
    $.each(DatosInfo,function(i,row){
            var json=new Object();
            json.idtarifaimpuesto=row.IDSubsidio.toString();
    ...
    var obj = new Object();
    obj.API="2278579883536E4E9482A4AEE603F795149A3A6FF7B8227704585CDCE23A0D08";
    obj.Parameters="";

...
function GetGrid() 
{
    $.when(ajaxCatalogo(69,"")).done(function (response) {
...
function DescargaExcel() {
	...
	setTimeout(() => {
		...
		if (rows.length > 0) {
			WriteExcel(rows, 'TarifaImpuestoRepDominicana');
		}
		ocultarCargador();
	}, 1000);
}
...
function Guardar()
{
    ...
    {
        var obj = new Object();
        obj.API="A561B1158DB02A9A4C7D62ADAA6DA66812534A72755A8AF754231E4C7F4536D7";
        obj.Parameters="";

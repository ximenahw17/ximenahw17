...
function GetGrid() 
{
    $.when(ajaxCatalogo(67,"")).done(function (response) {
...
function DescargaExcel() {
	...
	setTimeout(() => {
		...
		if (rows.length > 0) {
			WriteExcel(rows, 'TarifaImpuestoElSalvador');
		}
		ocultarCargador();
	}, 1000);
}
...
function Guardar()
{
    ...
    {
        var obj = new Object();
        obj.API="CE2225190BAC2E4CD45AD5099BBCBC488A408F664DC51AE9FD64814EAED1E2FF";
        obj.Parameters="";

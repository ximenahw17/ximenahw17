$(document).ready(function () {
	ConsultasBajasPendientes();
});

function ConsultasBajasPendientes() {
		...
		renderstatusbar: function (statusbar) {
			{
				statusbar.append($("<div id = 'divControlesPendientes'>"
					+ "<button type='button' onclick='Autorizar();' style='cursor: pointer; margin-top: 3px; margin-left: 5px; height:28px; max-height:28px;'><span style='position: relative;'><i class='fa fa-check fa-lg' style='padding-right:5px;'></i>Autorizar</span></button>"
					+ "<button type='button' onclick='Rechazar();' style='cursor: pointer; margin-top: 3px; margin-left: 5px; height:28px; max-height:28px;'><span style='position: relative;'><i class='fa fa-close fa-lg' style='padding-right:5px;'></i>Rechazar</span></button>"
					+ "</div>"));
			};
		},
		width: '100%',
	...
	let _data = {
		...
		"Descripcion_MovimientoIP": "Baja de empleados"
	}

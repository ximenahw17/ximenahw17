    ...
    $("#GridSubcontratante").jqxGrid(
        {
            ...
            columns: [
                ...
                {text: 'Porcentaje', datafield: 'Porcentaje', width: '20%', align: 'center', cellsalign: 'center', editable: false, columntype: 'numberinput', cellsformat:'d3' },      
            ],
            ready: function () {
                setTimeout(function () {
...
function obtieneDatosEmpleado() {
    if (obtieneParametroURL()) {
        ...
        ObjDatos.API="6D4A73C29CB1009BA3E7A617376605FA9E6A6DE3D1FF30F840F5E9025BF58514";
        ObjDatos.Parameters="";
                ...
                $.ajax({
                    ...
                    success: function (response) {                        
                        if (valdiateResponse(response)) {
                            ...
                            localStorage.setItem('SWRQYWlz',btoa(response.paislabora));
                            setTimeout(function(){
                                changeLocation("AltaEmpleado.html?IdRef="+response.Id_MPv3+"&estatus="+_estatus);
                            },500);
                        } 
                        else 
                        {
